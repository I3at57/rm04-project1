...
Cette trajectoire nous donne un coût total de $301800€$.

On peut ensuite construire une fonction pour calculer le coût
moyen unitaire pour une liste de paramètre donnés.
...
for (x in list_x) {
  ...
  list_simu <- c(list_simu,
                 compute_mean_cost_by_time(p = 1000,
                                           param_sys = parametres))
}

plot(x = list_x, y = list_simu)
```
...
Notre $x$ optimal se trouve proche de 1.45.
