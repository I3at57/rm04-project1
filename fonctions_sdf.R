...
plot_density <- function(loi = "exponential",
                         param = list(lambda = 0.1),
                         x = seq(0,40,0.001),
                         addon = FALSE) {
...
plot_distribution <- function(loi = "exponential",
                         param = list(lambda = 0.1),
                         x = seq(0,40,0.001),
                         addon = FALSE) {
...
plot_reliability <- function(loi = "exponential",
                         param = list(lambda = 0.1),
                         x = seq(0,40,0.001),
                         addon = FALSE) {
